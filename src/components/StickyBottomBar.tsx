...
const StickyBottomBar = () => (
  <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
    <div className="bg-background/95 backdrop-blur-md border-t border-border px-4 pt-2.5 pb-safe shadow-[0_-4px_20px_-4px_rgba(0,0,0,0.08)]">
      <div className="flex items-center gap-3 pb-2.5">
        <p className="flex-1 text-xs text-muted-foreground font-body">
