        ...
        {STEPS.map((step, i) => {
          ...
          return (
            ...
            >
              ...
              <span className="inline-block mb-1.5 text-xs font-body font-bold text-warm-gold bg-champagne/30 px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                Passo {step.number}
              </span>
              <h3 className="text-base md:text-lg font-display font-semibold text-foreground mb-1">{step.title}</h3>
